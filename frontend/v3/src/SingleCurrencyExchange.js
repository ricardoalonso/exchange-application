...
class CurrencyPicker extends Component {
    ...
    getCurrencies = () => {
        FetchUtils.fetchWithRetry(`${process.env.REACT_APP_GW_ENDPOINT}/currencies`)
    ...
    submit = (e) => {
        ...
        FetchUtils.fetchWithRetry(`${process.env.REACT_APP_GW_ENDPOINT}/exchangeRate/singleCurrency`, {
            method: 'POST',
            headers: {
